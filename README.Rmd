...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/eventreport)](https://CRAN.R-project.org/package=eventreport)
...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/eventreport)](https://CRAN.R-project.org/package=eventreport)
<!-- badges: end -->
...
> Sebastian van Baalen & Kristine Höglund (2026) Introducing the Modes and Agents of Election-Related Violence in Côte d'Ivoire (MAVERICK) Dataset. *Journal of Peace Research* 63(1): 98-106. [doi.org/10.1093/jopres/xjaf012](https://doi.org/10.1093/jopres/xjaf012)
>
> Sebastian van Baalen, David Edberg Landeström, Tor Richardson-Golinski & Kristine Höglund (2026) The MAVERICK Dataset Codebook Version 1.0. Uppsala: Department of Peace and Conflict Research, Uppsala University.

For methodological details, and when using the package, please refer to the following article:

> Sebastian van Baalen & Kristine Höglund (2026) Trials and Triangulations: Analyzing Aggregation Sensitivity in Event Data on Political Violence. *International Studies Quarterly* 70(1):sqag014. [doi.org/10.1093/isq/sqag014](https://doi.org/10.1093/isq/sqag014)

## Installation

You can install the released version of **eventreport** from [CRAN](https://CRAN.R-project.org) with:
...
devtools::load_all()
data("small_maverick_event_report", package = "eventreport")

table <- maverick_event_report %>% 
  dplyr::select(event_id, city, location, actor1, actor1_type, deaths_best, source) %>% 
  dplyr::filter(event_id == "CIV-0004")
